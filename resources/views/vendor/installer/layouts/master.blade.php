            ...
            <div class="box">
                <div class="header">
                    <div class="flex justify-center ">
                        <div class="installer_logo">
                            <img src="/images/logo.svg" style="height: 50px;" alt="Logo" />
                        </div>
                    </div>
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::admin_setup') }}">
                        <i class="step__icon fa fa-user" aria-hidden="true"></i>
                    </li>
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::environment')}} {{ isActive('LaravelInstaller::environmentDatabase')}}">
                        @if(Request::is('install/environment/database') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelInstaller::environmentDatabase') }}">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::environment')}} {{ isActive('LaravelInstaller::environmentInfo')}}">
                        @if(Request::is('install/environment/database') || Request::is('install/environment/info') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                        <a href="{{ route('LaravelInstaller::environmentInfo') }}">
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::permissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/environment/info') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelInstaller::permissions') }}">
                                <i class="step__icon fa fa-lock" aria-hidden="true"></i>
                            </a>
                        @else
                            <i class="step__icon fa fa-lock" aria-hidden="true"></i>
                        @endif
